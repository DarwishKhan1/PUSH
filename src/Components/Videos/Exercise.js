...
const Exercise = (props) => {
  ...
  const onSubmitVideo = (e) => {
    e.preventDefault();
    if (isFileSelected) {
      const storageRef = firebaseDb.storage().ref().child(`videos/exercise`);
      const thumbnailStorageRef = firebaseDb.storage().ref().child(`thumbnail/exercise`);
